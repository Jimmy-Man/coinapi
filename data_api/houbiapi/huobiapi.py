...
#from Utils import *
#import data_api.houbiapi.Utils
import base64
import datetime
import hashlib
import hmac
...
#ACCESS_KEY = "06e39fd5-290a27b3-c5bb0ff0-40e2c"
#SECRET_KEY = "67f2faa5-9507f01e-b14aa6c3-ca24a"
...
class huobiapi(object):
    ...
    # 获取 
    def get_currency(self,long_polling=None):
        """
        """
        params = {}
        if long_polling:
    ...
    def get_tickers(self,long_polling=None):
        """
        """
        params = {}
        if long_polling:
